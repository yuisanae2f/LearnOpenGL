...
void callback_scr(GLFWwindow* window, double xoffset, double yoffset);
...
int main()
{
    ...
    glfwSetScrollCallback(window, callback_scr);
...
void callback_scr(GLFWwindow* window, double xoffset, double yoffset)
{
    /** Zooming */
    extern Camera camera;
    camera.Zoom -= static_cast<float>(yoffset); /* reverse */
